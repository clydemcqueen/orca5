...
Typical usage:
scripts/generate_model.py models/orca5/model.sdf.in models/orca5/model.sdf 0
"""
...
camera_iyy = 0.001
camera_izz = 0.001
camera_far_clip = 5  # The furthest distance the camera can see
...
# Mass
base_mass = 10
total_mass = base_mass + 6 * propeller_mass + 2 * camera_mass + ping_mass
